...
const   Ver1Inputs          = document.querySelectorAll('.v-1'),
        ...
        HorizontalAnswers   = ['марьято', 'карибское', 'гренландия', 'кордильеры', 'верхнее', 'мексиканский', 'смерти'],
        VerticalAnswers     = ['миссисипи', 'саргассово', 'экваториальный', 'мерчисон', 'берингов', 'индейцы', 'гудзонов', 'лабрадор'];
