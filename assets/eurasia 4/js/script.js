...
const   Ver1Inputs          = document.querySelectorAll('.v-1'),
        ...
        HorizontalAnswers   = ['ханьцы', 'рис', 'рубль', 'ислам', 'буддизм', 'терракотовая', 'русский', 'шаолинь', 'охотское', 'дагестан', 'пекин'],
        VerticalAnswers     = ['крым', 'новосибирск', 'юань', 'гоби', 'мьянма', 'баренцево', 'карское', 'желтое'];
