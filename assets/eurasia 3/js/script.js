...
const   Ver1Inputs          = document.querySelectorAll('.v-1'),
        ...
        HorizontalAnswers   = ['тайга', 'янзцы', 'тибет', 'оймякон', 'протестантизм', 'пиай', 'мертвое', 'этнос', 'иртыш', 'хуанхэ', 'хиндустанцы'],
        VerticalAnswers     = ['панда', 'шанхай', 'арктический', 'дели', 'колизей', 'лихтенштейн', 'православие', 'умеренный'];
