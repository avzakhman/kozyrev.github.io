...
const   Ver1Inputs          = document.querySelectorAll('.v-1'),
        ...
        HorizontalAnswers   = ['монтевидео', 'кондор', 'галпагосская', 'лаплатская', 'уругвай', 'экваториальный', 'чили'],
        VerticalAnswers     = ['венесуэла', 'испанский', 'боливия', 'патус', 'парагвай', 'парана', 'париньяс', 'ориноко'];
