...
const   Ver1Inputs          = document.querySelectorAll('.v-1'),
        ...
        HorizontalAnswers   = ['уэльского', 'северное', 'аппалачи', 'вашингтон', 'денали', 'миссури', 'викинги', 'лаврентия', 'зеленая'],
        VerticalAnswers     = ['калифорнийский', 'сша', 'оттава', 'виннипег', 'тихий', 'канада'];
