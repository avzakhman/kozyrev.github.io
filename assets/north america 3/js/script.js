...
const   Ver1Inputs          = document.querySelectorAll('.v-1'),
        ...
        HorizontalAnswers   = ['колумбия', 'онтарио', 'мехико', 'юкатанский', 'ванкувенр', 'манагуа', 'никарагуа', 'мексика'],
        VerticalAnswers     = ['алеутские', 'куба', 'доминикана', 'каскадные', 'мичиган', 'гольфстрим', 'колумб'];
