...
const   Ver1Inputs          = document.querySelectorAll('.v-1'),
        ...
        HorizontalAnswers   = ['средиземное', 'азия', 'атлантический', 'тихий', 'флигели', 'индийский', 'волга', 'джомолунгма', 'россия'],
        VerticalAnswers     = ['рока', 'европа', 'индокитай', 'аравийский', 'японское', 'байкал', 'челюскин', 'кавказ', 'индостан', 'гималаи'];
