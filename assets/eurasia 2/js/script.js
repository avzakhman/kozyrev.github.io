...
const   Ver1Inputs          = document.querySelectorAll('.v-1'),
        ...
        HorizontalAnswers   = ['фудзияма', 'аравийское', 'пиренейский', 'шелихова', 'британские', 'ватикан', 'каспийское', 'ангара', 'скандинавский', 'таймыр'],
        VerticalAnswers     = ['дежнева', 'китай', 'москва', 'монголия', 'камчатка', 'эйфелева', 'индия', 'бенгальский', 'монако'];
