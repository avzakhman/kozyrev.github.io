...
const   Ver1Inputs          = document.querySelectorAll('.v-1'),
        ...
        HorizontalAnswers   = ['горн', 'бразилия', 'фолклендские', 'каракас', 'аргентинская', 'дрейка', 'атлантический'],
        VerticalAnswers     = ['магелланов', 'гальинас', 'асунсьон', 'аргентина', 'антильские', 'огненная', 'анды', 'кито'];
